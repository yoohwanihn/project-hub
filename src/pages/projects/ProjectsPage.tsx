              ...
              {projectList.map((p) => {
                ...
                return (
                  ...
                  >
                    {/* Context menu */}
                    <button
                      className="absolute top-3 right-3 p-1.5 rounded-lg text-zinc-300 hover:text-zinc-600 hover:bg-zinc-100 opacity-0 group-hover:opacity-100 transition-all"
